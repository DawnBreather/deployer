...
const (
// FIREBASE_RTDB_URL = "https://devops-practice-345014-default-rtdb.firebaseio.com/"
)
...
func (d *Deployment) Name() string {
	//return d.NameFirebaseConventioned()
	if d.Metadata.Name == "" {
...
func (d *Deployment) ExportDeployment() {
	...
	if err != nil {
		...
		//fmt.Println(string(jsonStringBase64))
